...
from ..kartica import generiraj_kartico_pdf, get_kartica_polja, kartica_filename, _KARTICA_POLJA_LABELE
...
async def kartica_pdf(
    ...
    pdf_bytes = generiraj_kartico_pdf(clan, leto, klub_ime, klub_oznaka, polja)
